<div class="col-sm-12 mt-4">
    <div class="bg-light rounded h-100 p-4 ">
        <h6 class="mb-4">Edit Cars</h6>
        <form wire:submit.prevent = "update">
            @csrf
            <div class="mb-3">
                <label for="policeNumber" class="form-label">Nomer Polisi</label>
                <input type="text" class="form-control" id="policeNumber" placeholder="masukan nomer polisi" wire:model="policeNumber" value="{{ @old('policeNumber') }}">
                @error('policeNumber')
